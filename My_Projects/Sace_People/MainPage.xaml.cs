...
namespace Sace_People
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            /// Create new object typu ContentControl
            ContentControl enemy = new ContentControl();
            enemy.Template = Resources["enemyTemplate"] as ControlTemplate;
            AnimateEnemy(enemy, 0, playArea.ActualWidth - 90, "(Canvas.Left)");
            AnimateEnemy(enemy, random.Next((int)playArea.ActualHeight - 100),
                      random.Next((int)playArea.ActualHeight - 90), "(Canvas.Top)");
        ...
        private void human_PointerPressed_1(object sender, PointerRoutedEventArgs e)
        {
            if (enemyTimer.IsEnabled)
            {
                humanCaptured = true;
