...
namespace Dictoniary
{
    public partial class Form1 : Form
    {
        ...
        private void playerNumber_SelectedIndexChanged(object sender, EventArgs e)
        {
            JerseyNumber jerseyNumber = retiredNumbers[(int)playerNumber.SelectedItem];
            playerName.Text = jerseyNumber.Player;
            playerYear.Text = jerseyNumber.YearRetired.ToString();
